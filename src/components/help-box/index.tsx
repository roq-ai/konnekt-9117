...
export const HelpBox: React.FC = () => {
  ...
  const customerRoles: string[] = ['Event Manager'];
  const tenantRoles: string[] = ['Event Organizer', 'Event Manager', 'Customer Support', 'Ticketing Agent', 'Admin'];
  const addOns: string[] = ['chat', 'notifications', 'file'];
  const applicationName = `Konnekt`;
